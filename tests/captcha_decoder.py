...
_letter_cases = "abcdefghjkmnpqrstuvwxyABCDEFGHIJKLMNOPQRSTUVWXYZ"  # 小写字母，去除可能干扰的i，l，o，z
_upper_cases = _letter_cases.upper()  # 大写字母
_numbers = ''.join(map(str, range(3, 10)))  # 数字
init_chars = ''.join((_letter_cases, _upper_cases, _numbers))

def draw_capture(seed=string.ascii_letters + string.digits, size=(120, 30), img_type = 'GIF', mode='RGB',
